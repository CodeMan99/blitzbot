 ...
 * @return the application authorize URL
 * @see https://discordapp.com/developers/docs/topics/permissions#bitwise-permission-flags
 */
function createApplicationUrl(permissions) {
  ...
  if (pArr) {
    perm = pArr.reduce(function(a, b) { return a | b; });
